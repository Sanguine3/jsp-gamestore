            ...
            <div class="wrapper wrapper--w790">
                <div class="card card-5">
                    <div class="card-heading">
                        <h2 class="title">Edit this account</h2>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="id" readonly value="${a.id}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="user" value="${a.user}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="pass" value="${a.pass}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <div class="rs-select2 js-select-simple select--no-search">
                                            <select name="admin">
                                                <c:if test = "${a.admin == 1}">
                                                    <option value="${a.admin}">Yes</option>
                                                </c:if>
                                                <c:if test = "${a.admin == 0}">
                                                    <option value="${a.admin}">No</option>
                                                </c:if>
                                            </select>
                        ...
                        <a href="account"><button class="btn btn--radius-2 btn--blue">Back</button></a>
                    </div>
                </div>
            </div>
        </div>
